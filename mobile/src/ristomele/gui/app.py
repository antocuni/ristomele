...
class RistoMeleApp(App):
    ...
    def new_order(self, table):
        ...
        fugassin = [
            Sep(name='Focaccini'),
            Foc(name='Zeneize de Me', price=1.5),
            Foc(name='Boscaiolo + cotto', price=5.5),
            Foc(name='Boscaiolo + crudo', price=5.5),
            Foc(name='Cotto', price=3.5),
            Foc(name='Cotto + stracchino', price=4.5),
            Foc(name='Crudo', price=3.5),
            Foc(name='Crudo + stracchino', price=4.5),
            Foc(name='Gorgonzola', price=3.5),
            Foc(name='Gorgonzola + noci', price=4),
            Foc(name='Gorgonzola + miele + noci', price=4.5),
            Foc(name='Marmellata fichi', price=3),
            Foc(name='Marmellata cigliege', price=3),
            Foc(name='Marmellata + stracchino', price=4),
            Foc(name='Nutella', price=3.5),
            Foc(name='Porchetta', price=5),
            Foc(name='Porchetta + stracchino', price=6),
            Foc(name='Porchetta + gorgonzola', price=6),
            Foc(name='Salame', price=3),
            Foc(name='Salame + gorgonzola', price=4),
            Foc(name='Salame + stracchino', price=4),
            Foc(name='Salsiccia', price=4.5),
            Foc(name='Salsiccia + stracchino', price=5.5),
            Foc(name='Salsiccia + gorgonzola', price=5.5),
            Foc(name='Stracchino', price=3),
        ]
