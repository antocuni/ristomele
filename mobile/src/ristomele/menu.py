...
def menu_sagra():
    return [
        ...
        Foc('Boscaiolo e cotto', 6),
        Foc('Boscaiolo e crudo', 6),
        Foc('Boscaiolo e speck', 6),
        Foc('Brie e miele', 5),
        Foc('Cotto', 4),
        ...
        Sep('Alla piastra'),
        Item(name='Salsiccia', price=5),
        Item(name='Salsiccia e patatine', price=6),
        Item(name='Porchetta', price=5),
        Item(name='Porchetta e patatine', price=6),
        Item(name='Patate fritte', price=3),

        Sep('BAR'),
        Drink('ECO-Bicchiere', 1),
        Drink('ASINELLO Corochinato', 2),
        Drink('Bicch. Piccolo Vino rosso', 1.5),
        Drink('Bicch. Grande Vino rosso', 3),
        Drink('Bicch. Piccolo Vino bianco', 1.5),
        Drink('Bicch. Grande Vino bianco', 3),
...
def menu_14_agosto():
    ...
    return [
        ...
        Sep(name='Vino'),
        Drink(name='Bicchiere piccolo dolcetto', price=1.5),
        Drink(name='Bicchiere piccolo bonarda', price=1.5),
        Drink(name='Bicchiere piccolo bianco', price=1.5),
        Drink(name='Bicchiere grande dolcetto', price=3),
        Drink(name='Bicchiere grande bonarda', price=3),
        Drink(name='Bicchiere grande bianco', price=3),
        Drink(name='Bottiglia vino dolcetto', price=8),
        Drink(name='Bottiglia vino bonarda', price=8),
