...
from .platform_api import (LLCamera, set_orientation, LANDSCAPE)
...
class XCamera(Camera):
    ...
    def on_picture_size(self, obj, size):
        if size == 'auto':
            return
        self.llcamera.set_picture_size(size)
    ...
    def shoot(self):
        ...
        self.llcamera.take_picture(filename, on_success)
