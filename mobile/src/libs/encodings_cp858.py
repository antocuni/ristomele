...
This file has been copied from the 2.7 stdlib. There is a hack to pretend it is importable as encodings.cp858, so that we can use things like 'foo'.encode('cp858')
"""

### <HACK HACK HACK>
import sys
import encodings
sys.modules['encodings.cp858'] = sys.modules[__name__]
encodings._cache.pop('cp858', None)
### </HACK HACK HACK>
